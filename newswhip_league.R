...
flynn <- data.frame(
        flynn = c(fpl_get_user_performance(user_id = 1991653)$season$total_points / 38, 
                   fpl_get_user_performance(user_id = 1991653)$entry$summary_overall_points / 11),
...
paddy <- data.frame(
        paddy = c(fpl_get_user_performance(user_id = 1094058)$season$total_points / 38, 
                   fpl_get_user_performance(user_id = 1094058)$entry$summary_overall_points / 11),
...
mike <- data.frame(
        mike = c(fpl_get_user_performance(user_id = 1033910)$season$total_points / 38, 
                   fpl_get_user_performance(user_id = 1033910)$entry$summary_overall_points / 11),
        season = c(fpl_get_user_performance(user_id = 1033910)$season$season_name, '2018/19'))


jonathan <- data.frame(
        jonathan = c(fpl_get_user_performance(user_id = 2231141)$season$total_points / 38, 
                   fpl_get_user_performance(user_id = 2231141)$entry$summary_overall_points / 11),
        season = c(fpl_get_user_performance(user_id = 2231141)$season$season_name, '2018/19'))

val <- data.frame(
        val = c(fpl_get_user_performance(user_id = 893932)$season$total_points / 38, 
                   fpl_get_user_performance(user_id = 893932)$entry$summary_overall_points / 11),
...
ryan <- data.frame(
        ryan = c(fpl_get_user_performance(user_id = 1648197)$season$total_points / 38, 
                   fpl_get_user_performance(user_id = 1648197)$entry$summary_overall_points / 11),
...
bruno <- data.frame(
        bruno = c(fpl_get_user_performance(user_id = 2933024)$season$total_points / 38, 
                   fpl_get_user_performance(user_id = 2933024)$entry$summary_overall_points / 11),
...
ben <- data.frame(
        ben = c(fpl_get_user_performance(user_id = 1051336)$season$total_points / 38, 
                   fpl_get_user_performance(user_id = 1051336)$entry$summary_overall_points / 11),
...
niall_neil <- data.frame(
        niall_neil = c(fpl_get_user_performance(user_id = 979073)$season$total_points / 38, 
                   fpl_get_user_performance(user_id = 979073)$entry$summary_overall_points / 11),
...
laura <- data.frame(
        laura = c(fpl_get_user_performance(user_id = 3461405)$season$total_points / 38, 
                   fpl_get_user_performance(user_id = 3461405)$entry$summary_overall_points / 11),
...
marilyn <- data.frame(
        marilyn = c(fpl_get_user_performance(user_id = 2928422)$season$total_points / 38, 
                   fpl_get_user_performance(user_id = 2928422)$entry$summary_overall_points / 11),
        season = c(fpl_get_user_performance(user_id = 2928422)$season$season_name, '2018/19'))

dani <- data.frame(
        dani = fpl_get_user_performance(user_id = 3581557)$entry$summary_overall_points / 11,
        season = '2018/19')

lewina <- data.frame(
        lewina = fpl_get_user_performance(user_id = 4103845)$entry$summary_overall_points / 11,
        season = '2018/19')
...
gg <- ggplot(df_long, aes(season_start, points, color = player, 
                    group = player)) +
...
gg <- gg + geom_label_repel(data = smal, 
                      aes(season_start, points, color = player,
                          label = player)) +
        scale_y_continuous(labels = scales::comma)


gg + labs(title = 'Average Points Per Season',
